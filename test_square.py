...
class SquareTest(unittest.TestCase):
    ''' модуль UNITTEST, проверябщий корректность вычислений функцией площади квадрата'''
   ...
   ''' модуль UNITTEST, проверябщий корректность вычислений функцией периметр2 квадрата'''
