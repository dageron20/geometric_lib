...
Для начала определяем набор входных данных для алгоритма. 

Зная алгоритм работы кода вычисляем вручную площадь и периметр круга. 

Записываем входные данные и результат подсчета в код. 

Далее запускаем работу кода и сравниваем полученный ответ. 

Если ответы совпадают, то код работает корректно. Если нет, то записываем ошибку в протокол.
...
Зная алгоритм работы кода вычисляем вручную площадь и периметр ппрямоугольника. 
...
Зная алгоритм работы кода вычисляем вручную площадь и периметр квадрата. 
