...
- ### Tests for circle.py
| Name of the test        | Input data  | Result             | Correctness_of_execution |
|-------------------------|:-----------:|:-------------------|:------------------------:|
| test_area_fraction      |   56.234    | 9934.541442970212  |           OK             |
| test_circle_area_pi     |     pi      | 31.006276680299816 |           OK             |
| test_circle_perimetr_pi |     pi      | 19.739208802178716 |           OK             |
| test_perimetr_big_data  | 57512357891 | 361360802081.9851  |           OK             |
- ### Tests for rectangle.py
| Name of the test                 |   Input data    | Result            | Correctness_of_execution |
|----------------------------------|:---------------:|:------------------|:------------------------:|
| test_rectangle_area_double       |     10, 10      | 100               |           OK             |
| test_rectangle_area_fraction     | 45.678, 21.5678 | 985.1739683999998 |           OK             |
| test_rectangle_perimetr_fraction | 789.123, 11.146 | 1600.538          |           OK             |
| test_perimetr_big_data           |      10, 0      | 20                |           OK             |
### Tests for square.py
| Name of the test                  |     Input data     | Result                  |Correctness_of_execution |
|-----------------------------------|:------------------:|:------------------------|:------------------------:|
| test_zero_area                    |         0          | 0                       |           OK             |
| test_square_area_big_data         |    77634100891     | 6027053621153966993881  |           OK             |
| test_square_perimetr_one          |         1          | 4                       |           OK             |
| test_square_perimetr_big_data     | 457997155624564456 | 1831988622498257824     |           OK             |
### Tests for triangle.py
| Name of the test                   |         Input data         | Result                 |Correctness_of_execution |
|------------------------------------|:--------------------------:|:-----------------------|:------------------------:|
| test_zero_height_area              |            5, 0            | 0                      |           OK             |
| test_triangle_area_big_data        | 9423847329131, 84823929121 | 3.9968387894666656e+23 |           OK             |
| test_perimetr_int                  |         63, 56, 89         | 208                    |           OK             |
| test_zero_perimetr                 |          0, 0, 0           | 0                      |           OK             |
## Math formulas
### Area
- Circle: S = πR²
- Rectangle: S = ab
